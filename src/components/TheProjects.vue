    ...
    <div class="flex">
      <div class="column-50">
        ...
        <div class="inner-container">
          ...
          <p>Today the website features over 25 pages, 80+ blogs, 23 home designs (built with a custom post type). It did have a home and land packages section that I built by integrating Halper API into a custom post type along with a custom search function built with AJAX. This section of the website is currently hidden however due to ...?</p>
    ...
    <div class="flex">
      <div class="column-50">
        ...
        <div class="inner-container">
          ...
          <p>Features for this website have been released in stages. I have created 3 custom post types and post page templates, along with a custom jQuery filter function. Similar to the buildtoday website I had integrated Halper API for home and land packages but this feature is currently hidden from the website due to ... ?</p>
